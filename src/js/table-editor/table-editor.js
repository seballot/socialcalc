...
SocialCalc.TableEditor.prototype.MoveECell = function(newcell, ensureVisible) { if (SocialCalc._app) return "A1"; return SocialCalc.MoveECell(this, newcell, ensureVisible);};
